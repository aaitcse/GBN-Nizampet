...
FEST_INSTAGRAM_URL = os.environ.get(
    "FEST_INSTAGRAM_URL", "https://www.instagram.com/gokuls.bhuvanam.nizampet"
)
FEST_WHATSAPP_GROUP_URL = os.environ.get(
    "FEST_WHATSAPP_GROUP_URL", "https://chat.whatsapp.com/JQOPHC3n4VBAUKKoIrgCs8"
)
# PLACEHOLDER committee number - replace before sharing the app, or the Need
# help button opens a chat with nobody. Digits with country code: 919876543210
FEST_HELP_WHATSAPP = os.environ.get("FEST_HELP_WHATSAPP", "919999999999")
